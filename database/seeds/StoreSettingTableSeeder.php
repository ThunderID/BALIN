...
class StoreSettingTableSeeder extends Seeder
{
	function run()
	{
		...
		$values 									= ['http://balin.id','http://balin.id/logo.png', 'http://www.facebook.com/balin.id', 'https://twitter.com/balinid', 'https://www.instagram.com/balinid', 'cs@balin.id', '0888 8888 8888', 'Ruko Puri Niaga A10 - Araya Kota Malang', 
														'<h1>About Us</h1></br>
