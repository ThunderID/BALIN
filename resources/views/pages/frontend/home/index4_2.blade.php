...
@section('content')
	<div class="container m-t-sm">
		<div class="row">
			<div class="col-md-12 col-sm-12 m-t-xl">
		...
		<div class="row m-t-xl">
			<div class="col-md-12 col-sm-12 text-center">
				<div class="col-md-12 col-sm-12 p-t-sm p-b-md" style="background-color:white;">
					...
					<div class="tab-content m-t-lg m-b-xl">
						...
						<div role="tabpanel" class="tab-pane in" id="batik_woman">
							<div class="row">
								<div class="col-md-12 col-sm-12 p-t-sm">
							...
							<div class="row card-animate">
								<div class="col-md-12 col-sm-12">
									<div class="col-md-12 col-sm-12 col-xs-12 p-t-md text-center">
										<h4 class="heading"><!-- Memperkenalkan Produk Terbaru Kami --></h4>
