		...
		<div class="col-lg-12">
			<div class="row">
				...
				<div class="col-md-4 col-sm-8 col-xs-12">
					{!! Form::open(array('route' => 'backend.report.customer.mostbuy', 'method' => 'get' )) !!}
						<div class="row">
			...
			@include('widgets.backend.pageelements.headersearchresult', ['closeSearchLink' => route('backend.report.customer.mostbuy') ])
