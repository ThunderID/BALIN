...
<?php 
$auditors              	= $auditor->ondate([(!is_null(Auth::user()->last_logged_at) ? Auth::user()->last_logged_at->format('Y-m-d H:i:s') : null), ' + 7 hours '])->userid($authentication->id)->with(['user'])->get();
?>
