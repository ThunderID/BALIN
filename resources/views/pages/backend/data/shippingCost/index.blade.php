		...
		<div class="col-lg-12">
			<div class="row">
				<div class="col-md-8 col-sm-4 hidden-xs">
					<a class="btn btn-default" href="{{ URL::route('backend.data.shippingCost.create') }}"> Data Baru </a>
				</div>
				<div class="hidden-lg hidden-md hidden-sm col-xs-12">
					<a class="btn btn-default btn-block" href="{{ URL::route('backend.data.shippingCost.create') }}"> Data Baru </a>
				</div>
				<div class="col-md-4 col-sm-8 col-xs-12">
					{!! Form::open(array('route' => 'backend.data.shippingCost.index', 'method' => 'get' )) !!}
						<div class="row">
			...
			@include('widgets.backend.pageElements.headerSearchResult', ['closeSearchLink' => route('backend.data.shippingCost.index') ])
			</br> 
			<div class="row">
				<div class="col-lg-12">
							...
							<tbody>
								...
								@else                                                                 
									...
									<tr>
										...
										<td>
											<a href="{{ URL::route('backend.data.shippingCost.show', ['id' => $data['id']]) }}"> Detail </a>, 
											<a href="{{ URL::route('backend.data.shippingCost.edit', ['id' => $data['id']]) }}"> Edit </a>, 
											<a href="#" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#shippingCost_del"
												...
												data-action="{{ route('backend.data.shippingCost.destroy', $data->id) }}">
												Hapus
											</a>  
										</td>    
									</tr>       
									...
									@include('widgets.pageElements.formModalDelete', [
											...
											'modal_route'   => route('backend.data.shippingCost.destroy', 0)
									])
								@endif
							</tbody>
						</table> 
