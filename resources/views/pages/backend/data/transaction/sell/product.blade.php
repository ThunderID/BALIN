...
<div class="row">
	...
	<div class="col-md-2">
		<div class="form-group">
			...
			{!! Form::input('text', 'price', null, ['class' => 'form-control text-right transaction-input-jum-price', "data-inputmask" => "'alias' : 'numeric', 'groupSeparator': ',', 'autoGroup': true, 'digits': 2, 'prefix': 'Rp', 'placeholder': '0'"]) !!}
		</div>
	</div>
	<div class="col-md-1">
		<div class="form-group">
