	...
	<table style="width:100%">
		...
		<tr>
			...
			<td style="width:90%">
				...
				<p>
					Login ke akun Anda untuk menikmati ratusan bonus belanja dari BALIN!
				</p>
			</td>
			<td style="width:5%"></td>
		</tr>
		...
		<tr>
			...
			<td style="width:90%; text-align:center;">
				<a href="{{route('frontend.join.index')}}" style="text-decoration:none; letter-spacing:2px; padding-top:15px; padding-bottom:15px; padding-right:15%; padding-left:15%; background-color:black; color:white;">LOGIN</a>
			</td>
			<td style="width:5%"></td>
		</tr>
