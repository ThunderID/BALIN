		...
		<li>
			<div class="row">
				<div class="col-xs-12 text-center" style=" ">
					<a href="{{ URL::route('frontend.cart.index') }}" class="btn-hollow btn-hollow-sm hollow-black m-r-sm">Lihat Cart</a>
					<a href="#" class="btn-hollow btn-hollow-sm hollow-black m-l-sm">Checkout</a>
				</div>
			</div>
		</li> 
	@else
