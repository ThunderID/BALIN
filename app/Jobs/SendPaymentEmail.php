...
class SendPaymentEmail extends Job implements SelfHandling
{
    ...
    public function handle()
    {
        ...
        $transaction    = Transaction::id($this->transaction->id)->with(['transactiondetails', 'transactiondetails.varian', 'transactiondetails.product', 'payment', 'user', 'pointlogs'])->first();
